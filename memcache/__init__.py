...
# number of seconds before retrying a dead server
_DEAD_RETRY = connection.DEAD_RETRY
# number of seconds before sockets timeout
_SOCKET_TIMEOUT = connection.SOCKET_TIMEOUT
